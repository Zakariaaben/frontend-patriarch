...
const FormParticulier = ({
  ...
  return (
    <div className="bg-customcolors-background lg:col-span-2  flex-col max-lg:row-span-2 lg:rounded-bl-md rounded-tl-md max-lg:rounded-tr-md overflow-hidden ">
      ...
      >
        <span className="text-customcolors-secondary-300 [text-shadow:1px_1px_8px_var(--tw-shadow-color)] shadow-secondarycolor-800  w-fit justify-self-center font-bold text-2xl -tracking-tighter p-2">
